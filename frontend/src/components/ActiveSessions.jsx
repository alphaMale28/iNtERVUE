  ...
  return (
    <div className="lg:col-span-2 card bg-base-100 border-2 border-primary/20 hover:border-primary/30">
      <div className="card-body">
        ...
        {/* SESSIONS LIST */}
        <div className="space-y-3 max-h-[400] overflow-y-auto pr-2">
          {isLoading ? (
            ...
            <div className="text-center py-16">
              <div className="size-20 mx-auto mb-4 bg-linear-to-br from-primary/20 to-secondary/20 rounded-3xl flex items-center justify-center">
